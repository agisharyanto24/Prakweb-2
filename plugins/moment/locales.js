;(function (global, factory) {
   ...
   factory(global.moment)
    ...
    moment.defineLocale('oc-lnc', {
        months: {
            standalone: 'genièr_agisèr_març_abril_mai_junh_julhet_agost_setembre_octòbre_novembre_decembre'.split(
                '_'
            ),
            format: "de genièr_de agisèr_de març_d'abril_de mai_de junh_de julhet_d'agost_de setembre_d'octòbre_de novembre_de decembre".split(
                '_'
            ),
            isFormat: /D[oD]?(\s)+MMMM/,
        },
